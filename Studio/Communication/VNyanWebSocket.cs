...
public static class VNyanWebSocket {
    ...
    private static int DangerZoneX1 = Properties.Settings.Default.VTuberDangerZoneX1;
    private static int DangerZoneX2 = Properties.Settings.Default.VTuberDangerZoneX2;
    private static int DangerZoneY1 = Properties.Settings.Default.VTuberDangerZoneY1;
    private static int DangerZoneY2 = Properties.Settings.Default.VTuberDangerZoneY2;
    private static int SafeZoneX1 = Properties.Settings.Default.VTuberSafeZoneX1;
    private static int SafeZoneX2 = Properties.Settings.Default.VTuberSafeZoneX2;
    private static int SafeZoneY1 = Properties.Settings.Default.VTuberSafeZoneY1;
    private static int SafeZoneY2 = Properties.Settings.Default.VTuberSafeZoneY2;
            ...
            if (line.Contains("Overworld")) { 
                ...
                if (result[0] == "Wind") {
                    ...
                    if (result[1].Contains("}")) {
                        ...
                        // hairCol = '#' + red.ToString("X2") + green.ToString("X2") + blue.ToString("X2");
